...
# This is educational purposes only, please maintain respectful and appropriate behavior. Note that you are solely responsible for your actions and conduct.

This repository contains code and documentation for performing WiFi deauthentication attacks using an ESP8266 microcontroller.
